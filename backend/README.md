...
## Project Structure
    ...
    ├── watershed_dashboard_34200  # Django project configurations
...
1. Clone this repo and `cd watershed_dashboard_34200`
...
2. Clone this repo and `cd watershed_dashboard_34200`
